...
--
-- Name: properties fk_atomic_numer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_numer FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
